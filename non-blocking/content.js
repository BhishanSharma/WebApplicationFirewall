chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === 'showWarning') {
    ...
    banner.innerHTML = `
      ...
      <div style="flex: 1;">
        <strong>WAF Alert:</strong> Potential threat detected - ${request.threats.join(', ')}
        <div style="font-size: 12px; opacity: 0.9; margin-top: 4px;">URL: ${request.url.substring(0, 80)}...</div>
      </div>
